...
library Commitment {
  ...
  /** Get value */
  function get(uint256 gameId, address player) internal view returns (bytes32 value) {
  ...
  function get(IStore _store, uint256 gameId, address player) internal view returns (bytes32 value) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256((gameId)));
    _keyTuple[1] = bytes32(uint256(uint160((player))));
  ...
  /** Set value */
  function set(uint256 gameId, address player, bytes32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256((gameId)));
    _keyTuple[1] = bytes32(uint256(uint160((player))));
  ...
  function set(IStore _store, uint256 gameId, address player, bytes32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256((gameId)));
    _keyTuple[1] = bytes32(uint256(uint160((player))));
